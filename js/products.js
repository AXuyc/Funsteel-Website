    ...
    type: [
      {
        ...
        specs: [
          ...
          ['Granularity', '0-5mm, 5-15mm, 10-50mm, 10-80mm, 10-150mm, 50-60mm, 60-70mm'],
      ...
      },
      {
        ...
        specs: [
          ...
          ['Granularity', '10-50mm, 10-80mm, 10-150mm'],
          ['Packing', '1 MT jumbo bags or bulk shipment'],
          ['Price', '<a href="contact-us.html">Contact us</a> for pricing']
        ]
      },
      ...
      },
      {
        ...
        specs: [
          ...
          ['Granularity', '10-50mm, 10-80mm, 10-150mm, 10-200mm'],
          ['Packing', '1 MT jumbo bags or bulk shipment'],
          ['Price', '<a href="contact-us.html">Contact us</a> for pricing']
        ]
      }
    ...
    type: [
      {
        ...
        specs: [
          ['Chemical Composition', 'Chromium(Cr): 50-65%, Carbon(C): ≤0.5%, Silicon(Si): ≤2.0%, Phosphorus(P): ≤0.03%, Sulfur(S): ≤0.03%'],
          ['Granularity', '10-60mm, 10-200mm'],
          ['Packing', '1 MT jumbo bags or bulk shipment'],
          ['Price', '<a href="contact-us.html">Contact us</a> for pricing']
        ]
    ...
    type: [
      {
        ...
        specs: [
          ['Chemical Composition', 'Chromium(Cr): 50-65%, Carbon(C): ≤0.15%, Silicon(Si): ≤2.0%, Phosphorus(P): ≤0.03%, Sulfur(S): ≤0.03%'],
          ['Granularity', '10-60mm, 10-200mm'],
          ['Packing', '1 MT jumbo bags or bulk shipment'],
          ['Price', '<a href="contact-us.html">Contact us</a> for pricing']
        ]
    ...
    type: [
      {
        ...
        specs: [
          ['Chemical Composition', 'Silicon(Si): >35%, Chromium(Cr): >30%, Carbon(C): 0.02~1.0%, Phosphorus(P): ≤0.04%, Sulfur(S): ≤0.04% '],
          ['Granularity', '10-60mm, 10-200mm'],
          ['Packing', '1 MT jumbo bags or bulk shipment'],
          ['Price', '<a href="contact-us.html">Contact us</a> for pricing']
        ]
    ...
    type: [
      {
        ...
        specs: [
          ...
          ['Granularity', '10-60mm'],
          ['Packing', '1 MT jumbo bags or 100kg steel drum'],
          ['Price', '<a href="contact-us.html">Contact us</a> for pricing']
        ]
      }
    ]
